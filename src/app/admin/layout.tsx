...
const AdminLayout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const links = (
        <>
            ...
            <li>
                <Link href="/admin/customers" className={pathname === "/admin/customers" ? "active" : ""}>
                    <FaUserFriends />
                    Customers
                </Link>
            </li>
            ...
            <li>
                <Link href="/admin/addProduct" className={pathname === "/admin/addProduct" ? "active" : ""}>
                    <FaRegPlusSquare />
                    Add Product
                </Link>
            </li>
    ...
    const linksForMobile = (
        <>
            <li>
                <Link href="/admin" className={pathname === "/admin" ? "active" : ""}>
                    <RxDashboard />
                    <span className={`${pathname === "/admin" ? "active flex" : "hidden"} text-sm`}>Dashboard</span>
                </Link>
            </li>
            ...
            <li>
                <Link href="/admin/orders" className={pathname === "/admin/orders" ? "active" : ""}>
                    <FaShoppingCart />
                    <span className={`${pathname === "/admin/orders" ? "active flex" : "hidden"} text-sm`}>Orders</span>
                </Link>
            </li>
            <li>
                <Link href="/admin/customers" className={pathname === "/admin/customers" ? "active" : ""}>
                    <FaUserFriends />
                    <span className={`${pathname === "/admin/customers" ? "active flex" : "hidden"} text-sm`}>
                        Customers
                    </span>
                </Link>
            </li>
            <li>
                <Link href="/admin/products" className={pathname === "/admin/products" ? "active" : ""}>
                    <FaClipboardList />
                    <span className={`${pathname === "/admin/products" ? "active flex" : "hidden"} text-sm`}>
                        Products
                    </span>
                </Link>
            </li>
            <li>
                <Link href="/admin/categories" className={pathname === "/admin/categories" ? "active" : ""}>
                    <FaListUl />
                    <span className={`${pathname === "/admin/categories" ? "active flex" : "hidden"} text-sm`}>
                        Categories
                    </span>
                </Link>
            </li>
            <li>
                <Link href="/admin/addProduct" className={pathname === "/admin/addProduct" ? "active" : ""}>
                    <FaRegPlusSquare />
                    <span className={`${pathname === "/admin/addProduct" ? "active flex" : "hidden"} text-sm`}>
                        Add Product
                    </span>
                </Link>
            </li>
            <li>
                <Link href="/admin/addCategory" className={pathname === "/admin/addCategory" ? "active" : ""}>
                    <TbCategoryPlus />
                    <span className={`${pathname === "/admin/addCategory" ? "active flex" : "hidden"} text-sm`}>
                        Add Category
                    </span>
                </Link>
            </li>
                    ...
                    <div className="h-screen p-3 space-y-2 w-60 bg-blue-200 text-gray-800 sticky top-0">
                        <div className="flex items-center p-2 space-x-4 bg-[#B8CEDC] rounded-2xl">
                            ...
                            <div>
                                ...
                                <span className="flex items-center space-x-1 text-sm font-thin">Admin Panel</span>
                            </div>
                        </div>
                        <div className="p-2 bg-[#B8CEDC] rounded-2xl h-[92%] flex flex-col justify-between">
                            <ul id="link1" className="menu menu-vertical text-[16px] px-1 gap-2 text-gray-500">
                                {links}
                            </ul>
