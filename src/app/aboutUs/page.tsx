...
const Page = () => {
    return (
        <>
        <h1 className="text-center text-xl font-semibold italic mt-10">About Us</h1>
        <div className="max-w-screen-xl mx-auto p-4 my-10 xl:my-20 gap-5">
            <Image
                placeholder="blur"
                ...
                className="rounded float-right ml-3 pb-5 w-full sm:w-[350px] md:w-[400px] lg:w-[450px] xl:w-[550px]"
                width={500}
                height={500}
                alt="menverse"
            />
